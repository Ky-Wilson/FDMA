    ...
    <div class="row">
      <div class="col-lg-8">
        <div id="page-slider" class="page-slider small-bg">
          <div class="item">
            <img loading="lazy" class="img-fluid" src="{{ asset('assets/site/images/projects/project1.jpg') }}" alt="Project Image BMI Finances 1" />
          </div>

          <div class="item">
            <img loading="lazy" class="img-fluid" src="{{ asset('assets/site/images/projects/project_detail1.jpg') }}" alt="Project Image BMI Finances 2" />
          </div>
